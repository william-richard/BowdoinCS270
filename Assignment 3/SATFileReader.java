...
/** Modified by Will Richard and Owen Callen 2009 */
...
public class SATFileReader {
	...
	//Public method to open a SAT file
	public static int[][] getFormulaArray(String filename) {
		SATFileReader.filename = filename;
	...
	private static void openSATFile(){
	...
	private static void readSATFile() {
