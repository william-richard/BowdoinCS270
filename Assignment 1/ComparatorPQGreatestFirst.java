...
/*
  ...
  as the comparator in a greatest-first PriorityQueue.
...
public class ComparatorPQGreatestFirst implements Comparator<SearchTreeNode> {
	
    public final int compare(SearchTreeNode x, SearchTreeNode y) {
	
	// -1 indicates that x should be closer to the head than y, 
	//    i.e. *higher* path cost nodes should be closer to
	//    the head
